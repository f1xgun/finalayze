...
UNIVERSE: dict[str, list[str]] = {
    "us_tech": [
        ...
        "ADBE", "CRM", "INTC", "AMD", "CSCO", "ORCL", "QCOM", "TXN",
        "ASML", "AMAT", "MU", "NOW",
    ],
    "us_broad": [
        "SPY", "QQQ", "DIA", "IWM", "JNJ", "PG", "KO", "WMT", "XOM", "CVX",
        "PEP", "COST", "MCD", "NKE", "DIS", "HD", "LOW", "TGT", "SBUX", "CL",
    ],
    "us_finance": [
        "JPM", "BAC", "GS", "MS", "V", "MA", "BRK-B", "C",
        "SCHW", "AXP", "USB", "PNC", "TFC", "BLK", "SPGI",
    ],
    "us_healthcare": [
        "UNH", "LLY", "PFE", "ABBV", "MRK", "TMO", "ABT", "AMGN",
        "JNJ", "BMY", "GILD", "VRTX", "ISRG", "MDT", "ZTS",
    ],
    "us_industrial": [
        "CAT", "DE", "HON", "UNP", "BA", "GE", "RTX", "LMT",
        "MMM", "ETN", "ITW", "EMR", "PH", "WM", "RSG",
    ],
    "ru_blue_chips": [
        "SBER", "GAZP", "LKOH", "GMKN", "YNDX", "VTBR",
        "SBERP", "MGNT", "POLY", "ALRS",
    ],
    "ru_energy": [
        "ROSN", "LKOH", "NVTK", "TATN", "GAZP",
        "SNGS", "TRNFP", "IRAO",
    ],
}
